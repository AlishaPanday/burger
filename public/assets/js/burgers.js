...
document.addEventListener('DOMContentLoaded', (event) => {
    ...
    if (changeStateBtns) {
      changeStateBtns.forEach((button) => {
        button.addEventListener('click', (e) => {
          // Grabs the id of the element that goes by the name, "id"
          const id = e.target.getAttribute('data-id');
        // const newSleep = e.target.getAttribute('data-newstate');
          const newState = e.target.getAttribute('data-newstate');
          ...
          fetch(`/api/burgers/${id}`, {
            ...
            if (response.ok) {
              console.log(`changed eaten status to: ${newState}`);
              location.reload('/');
            } else {
